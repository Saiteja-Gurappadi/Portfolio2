...
const About = () => {
  return (
    <div
      className=" h-[100vh] flex flex-col gap-[30px] items-center p-[30px] text-center text-white bg-gradient-to-tr border-t border-gray-600 border-solid  from-black via-slate-900 to-black"
      id="about"
    >
